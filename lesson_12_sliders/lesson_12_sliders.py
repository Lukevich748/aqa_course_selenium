...
def move_slider(slider_locator: tuple, current_point_attr_name: str, target_point: int):
    min_value = -5
    max_value = 20

    if target_point < min_value or target_point > max_value:
        raise ValueError(f"Target point '{target_point}' is out of range. Must be between '{min_value}' and '{max_value}'.")
